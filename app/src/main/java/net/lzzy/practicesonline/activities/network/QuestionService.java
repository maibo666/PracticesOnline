...
public class QuestionService {
    ...
    public static List<Question> getQuestions(String json, UUID practiesId) throws IllegalAccessException, JSONException, InstantiationException {
        JsonConverter<Question> converter=new JsonConverter<>(Question.class);
        List<Question> questions=converter.getArray(json);
        for (Question question:questions){
            question.setPracticeId(practiesId);
        }
        return questions;
    }

    public static List<Option> getOptionsFromJson(String jsonOptions,String jsonAnswers)
            throws IllegalAccessException, JSONException, InstantiationException {
